...
ctx.lineWidht = 1;
ctx.rect(x150, y143,432-width,200-height);
ctx.stroke();
...
ctx.lineWidht = 5;
ctx.arc(x150, y143,40-r, 0-startAngle,2*Math.PIendAngle);
ctx.stroke();
...
ctx.lineWidht = 5;
ctx.arc(x350, y210 ,40-r, 0-startAngle,2*Math.PIendAngle);
ctx.stroke();
...
ctx.strokeStyle = "blue";
ctx.lineWidht = 5;
ctx.arc(x210, y40,40-r, 0-startAngle,2*Math.PIendAngle);
ctx.stroke();
...
ctx.strokeStyle = "blue";
ctx.lineWidht = 5;
ctx.arc(x400, y250,40-r, 0-startAngle,2*Math.PIendAngle);
ctx.stroke();
